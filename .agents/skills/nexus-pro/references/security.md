...
Este documento define la revisión de seguridad obligatoria para NEXUS-PRO. Todo cambio debe evaluarse antes de entregarse, especialmente si toca autenticación, autorización, datos privados, cargas de archivos, pagos, integraciones, sincronizaciones, reportes o administración.
...
Además, debe cubrir los riesgos específicos exigidos por NEXUS-PRO:
