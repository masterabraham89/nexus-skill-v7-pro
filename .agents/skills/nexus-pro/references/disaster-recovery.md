...
Este documento define prácticas de recuperación ante desastres para NEXUS-PRO. El objetivo es reducir impacto, pérdida de datos y tiempo de indisponibilidad.
