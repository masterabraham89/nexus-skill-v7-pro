...
Este documento define límites operativos para Antigravity cuando programa usando NEXUS-PRO. Su objetivo es evitar daños colaterales, refactors innecesarios, cambios silenciosos de contrato, pérdida de datos, migraciones peligrosas o decisiones no justificadas.
