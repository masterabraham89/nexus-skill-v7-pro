...
Este documento define la arquitectura obligatoria para proyectos desarrollados con NEXUS-PRO. La arquitectura debe favorecer separación de responsabilidades, bajo acoplamiento, alta cohesión, seguridad, mantenibilidad y escalabilidad.
