...
Este documento define las reglas frontend para React / TypeScript en NEXUS-4EVER. El frontend debe ser modular, tipado, accesible, performante, mantenible y seguro.
