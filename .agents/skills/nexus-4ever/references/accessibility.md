...
Este documento define los estándares de accesibilidad para interfaces desarrolladas con NEXUS-4EVER. La meta mínima es cumplir WCAG 2.1 nivel AA cuando exista UI.
