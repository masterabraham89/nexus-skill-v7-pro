...
Este documento define las prácticas backend obligatorias para Laravel / PHP dentro de NEXUS-4EVER. El backend debe ser seguro, modular, testeable, auditable y preparado para producción.
